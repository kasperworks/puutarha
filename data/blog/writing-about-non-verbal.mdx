...
I'm trying to express in this post. They're very difficult to express verbally,
...
The ideal model would be to experience the world with the right hemisphere,
...
It doesn't mean that operating by vibes entirely is desireable, it's important to do the work
and understand the environment and variables within. It's just that verbalized reasoning is
...
People in wu-wei have de, a radiance that others can detect, an outward signal that one is in wu-wei.
Because spontaneity is hard to fake, we intuit that people with de are trustworthy and authentic.
...
To reach it, it seems to be beneficial to have some slack, some inefficiency in the system.
