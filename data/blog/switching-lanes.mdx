...
In my personal experience, learning to write a programming language well enough to make it your primary source of income will require spending a big chunk of your free time immersed in the subject for about a year. This process may be faster if you don't need to work a full-time job and be a parent, but it's possible to accomplish even with such responsibilities.
