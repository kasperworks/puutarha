...
firm or a team to follow. Doing well on these measures seems to correlate with making more money, for example.

You may read more on that here, otherwise I'll give a short summary:
...
Stability: How often stuff breaks and how long does it stay broken.
Throughput: How long does it take to get from an idea to an app and how often does a team ship code to production.
...
significant correlation on good outcomes and these two measures.

Stability is tracked by two metrics: the change failure rate, or how often a change introduces a defect,
and recovery failure time -- how long does it take to recover from a failure.

Throughput can be distilled to two metrics as well: lead time, or how long does it take to get
from idea to working software, and frequency of deployments to production.
//

### Simplify

David Farley, the guy talking about software engineering as a creative discipline, talks about managing complexity
as the second core skill for a software engineer.

The way I personally relate to this is taking a quick glance of the source code of any modern JavaScript app.
...
There's a reason that's mostly hidden and behind installer scripts. It's great, and it's dangerous.

The dangers of complexity are best articulated by Jonathan Blow in his brilliant talk from 2019,
...
One solution to fight this could be to simplify at every level: hardware, operating systems, application code,
network connections, compilers, user interfaces and so on. Luckily there are also tools and techniques that help
...
It's still a useful conceptual difference to make, lest we all become dependent on low-code tools,
with no one left to understand their inner workings.
...
Yet there's also a need to maintain a creative approach to building software. Often we have no clue
...
It might even help you get in touch with seemingly unrelated things. But that's a topic
for [another post](/blog/writing-about-non-verbal).
